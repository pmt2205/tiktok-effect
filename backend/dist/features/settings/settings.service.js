    ...
    async getSettingsForUser(username) {
        try {
            ...
            return {
                ...
                menuFrame: settingsDoc.menuFrame || '',
                menuFrameScale: settingsDoc.menuFrameScale !== undefined ? settingsDoc.menuFrameScale : 1.0,
                menuScrollThreshold: settingsDoc.menuScrollThreshold !== undefined ? settingsDoc.menuScrollThreshold : 5,
                ...
                jarDanceEnabled: settingsDoc.jarDanceEnabled !== undefined ? settingsDoc.jarDanceEnabled : true,
                jarDancePosition: settingsDoc.jarDancePosition || 'left',
                jarDanceScale: settingsDoc.jarDanceScale !== undefined ? settingsDoc.jarDanceScale : 1.0,
                jarDanceOffsetX: settingsDoc.jarDanceOffsetX !== undefined ? settingsDoc.jarDanceOffsetX : 185,
                jarDanceVideo: settingsDoc.jarDanceVideo || '/dance/capy_dance.mp4',
                ...
                videoEnabled: settingsDoc.videoEnabled !== undefined ? settingsDoc.videoEnabled : true,
                soundEnabled: settingsDoc.soundEnabled !== undefined ? settingsDoc.soundEnabled : true,
                treeEnabled: settingsDoc.treeEnabled !== undefined ? settingsDoc.treeEnabled : this.defaultSettings.treeEnabled,
                treeType: settingsDoc.treeType || 'standard',
                treeImage: settingsDoc.treeImage || 'tree.png',
                ...
                topGifterEnabled: settingsDoc.topGifterEnabled !== undefined ? settingsDoc.topGifterEnabled : true,
                topGifterDuration: settingsDoc.topGifterDuration !== undefined ? settingsDoc.topGifterDuration : 4,
                topGifterRankLimit: settingsDoc.topGifterRankLimit !== undefined ? settingsDoc.topGifterRankLimit : 5,
                topGifterMinDiamonds: settingsDoc.topGifterMinDiamonds !== undefined ? settingsDoc.topGifterMinDiamonds : 1,
                likeLeaderboardEnabled: settingsDoc.likeLeaderboardEnabled !== undefined ? settingsDoc.likeLeaderboardEnabled : true,
                likeLeaderboardTitle: settingsDoc.likeLeaderboardTitle || 'BXH TAP TAY ❤️',
                likeLeaderboardX: settingsDoc.likeLeaderboardX !== undefined ? settingsDoc.likeLeaderboardX : 78,
                likeLeaderboardY: settingsDoc.likeLeaderboardY !== undefined ? settingsDoc.likeLeaderboardY : 15,
                likeLeaderboardScale: settingsDoc.likeLeaderboardScale !== undefined ? settingsDoc.likeLeaderboardScale : 1.0,
                likeLeaderboardTopCount: settingsDoc.likeLeaderboardTopCount !== undefined ? settingsDoc.likeLeaderboardTopCount : 3,
                likeLeaderboardResetAt: settingsDoc.likeLeaderboardResetAt !== undefined ? settingsDoc.likeLeaderboardResetAt : 0,
                allowNpc,
    ...
    async updateSettingsForUser(username, newSettings) {
        try {
            ...
            const result = {
                ...
                menuFrame: updated.menuFrame || '',
                menuFrameScale: updated.menuFrameScale !== undefined ? updated.menuFrameScale : 1.0,
                menuScrollThreshold: updated.menuScrollThreshold !== undefined ? updated.menuScrollThreshold : 5,
                ...
                jarDanceEnabled: updated.jarDanceEnabled !== undefined ? updated.jarDanceEnabled : true,
                jarDancePosition: updated.jarDancePosition || 'left',
                jarDanceScale: updated.jarDanceScale !== undefined ? updated.jarDanceScale : 1.0,
                jarDanceOffsetX: updated.jarDanceOffsetX !== undefined ? updated.jarDanceOffsetX : 185,
                jarDanceVideo: updated.jarDanceVideo || '/dance/capy_dance.mp4',
                ...
                videoEnabled: updated.videoEnabled !== undefined ? updated.videoEnabled : true,
                soundEnabled: updated.soundEnabled !== undefined ? updated.soundEnabled : true,
                treeEnabled: updated.treeEnabled !== undefined ? updated.treeEnabled : this.defaultSettings.treeEnabled,
                treeType: updated.treeType || 'standard',
                treeImage: updated.treeImage || 'tree.png',
                ...
                topGifterEnabled: updated.topGifterEnabled !== undefined ? updated.topGifterEnabled : true,
                topGifterDuration: updated.topGifterDuration !== undefined ? updated.topGifterDuration : 4,
                topGifterRankLimit: updated.topGifterRankLimit !== undefined ? updated.topGifterRankLimit : 5,
                topGifterMinDiamonds: updated.topGifterMinDiamonds !== undefined ? updated.topGifterMinDiamonds : 1,
                likeLeaderboardEnabled: updated.likeLeaderboardEnabled !== undefined ? updated.likeLeaderboardEnabled : true,
                likeLeaderboardTitle: updated.likeLeaderboardTitle || 'BXH TAP TAY ❤️',
                likeLeaderboardX: updated.likeLeaderboardX !== undefined ? updated.likeLeaderboardX : 78,
                likeLeaderboardY: updated.likeLeaderboardY !== undefined ? updated.likeLeaderboardY : 15,
                likeLeaderboardScale: updated.likeLeaderboardScale !== undefined ? updated.likeLeaderboardScale : 1.0,
                likeLeaderboardTopCount: updated.likeLeaderboardTopCount !== undefined ? updated.likeLeaderboardTopCount : 3,
                likeLeaderboardResetAt: updated.likeLeaderboardResetAt !== undefined ? updated.likeLeaderboardResetAt : 0,
                allowNpc,
                allowedNpcCategories,
            };
