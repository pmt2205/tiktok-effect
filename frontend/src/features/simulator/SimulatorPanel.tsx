  ...
  return (
    ...
    >
      <div className="simulator-grid">
        ...
        <div className="sim-card">
          <h3>
            <i className="fa-regular fa-comment sim-gift-icon-fa" />
            Chat Message
          </h3>
          <p className="sim-card-desc">Simulate a real-time message in the live stream.</p>
          <Button variant="sim" fullWidth onClick={onSimulateChat}>
            <i className="fa-solid fa-paper-plane" /> Send Chat Message
          </Button>
        </div>
      </div>
    </GlassCard>
